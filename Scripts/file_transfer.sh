...
if [ "$host_md5" == "" ] || [ "$vm1_md5" == "" ]; then
        echo -n -e "No route to host\t" | tee -a /root/test.log
elif [ "$host_md5" == "$vm1_md5" ]; then
...
if [ "$host_size" == "" ] || [ "$vm1_size" == "" ]; then
        echo "No route to host" | tee -a /root/test.log
elif [ "$host_size" == "$vm1_size" ]; then
